...
class WelcomeScreenViewController: UIViewController {
    ...
    private let circleImageView = UIImageView(image: UIImage(named: ""))
    ...
    private let slides = [
        Slide(title: nil, description: " ", image: "scorepios"),
        Slide(title: "".localized, description: " ", image: "scorepios"),
        Slide(title: "".localized, description: " ", image: "scorepios"),
        Slide(title: "".localized, description: " ", image: "scorepios")
    ]
